...
This project analyses a full year of sales data from a Nigerian general provisions store, the kind of neighbourhood shop that stocks everything from Rice and Indomie noodles to Milo, palm oil, and Pampers.
...
![Category Revenue & Margin](chart1_category_revenue.png)

### Top 10 Products by Revenue
![Top 10 Products](chart2_top10_products.png)

### Monthly Revenue & Profit Trend
![Monthly Trend](chart3_monthly_trend.png)

### Sales Activity by Day of Week
![Day of Week](chart4_day_of_week.png)

### Payment Method Breakdown
![Payment Methods](chart5_payment_methods.png)

### Effect of Discount on Profit Margin
![Discount Impact](chart6_discount_impact.png)
...
2. **Limit 10% discount events.** A 10% discount reduces average margins by nearly 9 percentage points. If discounts are used, 5% is a safer threshold.
3. **Promote POS and bank transfer payments.** With 54% of transactions still in cash, there is meaningful operational risk. Incentivising digital payments would reduce this.
4. **Maintain buffer stock for fast movers on Fridays and Saturdays.** Indomie, Maggi Cubes, and Gala Sausage Roll see their highest demand at weekends.
5. **Review Snacks & Confectionery pricing strategy.** At 23% average margin, the highest of all categories expanding variety here could improve overall profitability without adding complexity.
...
[LinkedIn](https://linkedin.com/in/precious-nwachukwu-873b432b7) | [Portfolio](https://bit.ly/PreciousNwachukwuDataPortfolio) | [GitHub](https://github.com/PreciousNwachukwu)
